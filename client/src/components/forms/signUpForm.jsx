...
export default function SignupForm() {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            console.log('Submitting signUp with variables:', variables);

            // Call signUp mutation function with the form data
            const { data } = await mutations.signUp({ variables });
                ...
                <section className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                    ...
                    <section className="mt-10 sm:col-span-2 submit p-2">
                        ...
                        <button
                            ...
                            className="rounded block p-3.5 text-center text-sm text-grey-900 font-semibold shadow-sm"
                        ><Link id="login-btn" to='/login' className="justify-between m-3">Login</Link></button>
                    </section>
                </section>
            </form>
            {errorMessage && (
